...
// Remove unnecessary Socket import
...
const MessageBar = () => {
  ...
  const { selectedChatType, selectedChatData,setIsUploading,setFileUploadProgress} = useAppStore();
  ...
  return (
    <div className="h-[10vh] bg-[#1c1d25] flex justify-center items-center px-8 mb-6 gap-6">
      <div className="flex-1 flex bg-[#2a2b33] rounded-md items-center gap-5 pr-5">
        ...
        <div className="relative"> {/* Fix typo here */}
          <button
            className="text-neutral-500 focus:border-none focus:outline-none focus:text-white duration-300 transition-all"
            onClick={() => setEmojiPickerOpen(!emojiPickerOpen)} // Toggle the emoji picker
          >
